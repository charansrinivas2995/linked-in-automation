...
public class FramesTest {
	...
	public static final String URL = "https://demoqa.com/frames";
	...
	public static void main(String[] args) throws InterruptedException, FileNotFoundException, IOException {
		...
		String headerTextFrame2 = driver.findElement(By.id("sampleHeading")).getText();

		System.out.println("headerText : " + headerTextFrame2);
