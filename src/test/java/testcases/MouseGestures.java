...
public class MouseGestures {
	...
	public static void main(String[] args)
		...
		action.moveToElement(driver.findElement(By.xpath("//a[contains(text(),'Facebook Lite')]"))).build().perform();

		Thread.sleep(3000);

		action.contextClick(driver.findElement(By.xpath("//a[contains(text(),'Facebook Lite')]"))).build().perform();
